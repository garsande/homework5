...
class Addition(Operation):
    """
    Addition operation implementation to add two numbers.
    """
...
class Subtraction(Operation):
    """
    Subtraction operation implementation to subtract one number from another.
    """
...
class Multiplication(Operation):
    """
    Multiplication operation implementation to multiply two numbers.
    """
...
class Division(Operation):
    """
    Division operation implementation to divide one number by another.
...
class Power(Operation):
    """
    Power (exponentiation) operation implementation to calculate one 
...
class Root(Operation):
    """
    Root operation implementation to calculate the nth root of a number
    """
